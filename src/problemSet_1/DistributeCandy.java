...
//))));
    ...
    public static int candy(ArrayList<Integer> A) {
        ...
        while(changes < A.size()) {

            for(int i = 0; i < arr.length; i++) {
                if (    arr[i] != 0 ||
                        (i != 0 && arr[i-1] == 0 && A.get(i-1) < A.get(i)) ||
                                (i != A.size()-1 && arr[i+1] == 0 && A.get(i+1) < A.get(i))
                ) continue;
